...
_What is the goal of the project (from a learning and product perspective)? 
* To learn more about the game process.
* Learn about the different components of a game from art to design to production.
* Learn how to work with peers on a project in preparation for the industry.

_Who is your target audience? 
* A more mature and adult audience.
* Those who like killing large hordes of enemies.
* Those interested in darker games.

_How will you define success?_
* Having a playable, running, unique game.
* Being able to have multiple levels and the chance to develop the story.

## Communications

### Discord
_Add info about how to join/use your team's Discord channel. What is it?_
* Our discord channel is sec2_team6
* It's our main communication 
* It's what we use to make sure our meeting times are still good and that everyone is okay.
* Eventually, we'll use it to let everyone know about the work we do outside of class/meetings.
